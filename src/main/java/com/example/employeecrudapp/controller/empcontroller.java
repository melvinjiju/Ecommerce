...
public class empcontroller {
    ...
    public empcontroller(service helper, jwtservice jwtservice, PasswordEncoder passwordencorder, AuthenticationManager authenticationManager, userrepo repo) {
